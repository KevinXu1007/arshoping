...
<body>
	...
	<table cellSpacing="1" cellPadding="0" width="100%" align="center"
		...
		<TBODY>
			<tr>
				<td class="ta_01" align="center" bgColor="#afd1f3"><strong>First Catalog List</strong>
				</TD>
			</tr>
			<tr>
			...
			<tr>
				<td class="ta_01" align="center" bgColor="#f5fafe">
					<table cellspacing="0" cellpadding="1" rules="all"
						...
						<tr align="center">
							<td colspan="7">page:<c:out value="${ page}" />/<c:out value="${count}" />
							 <c:if test="${page != 1 }">
									<a href="listCategory/1">first</a>|
								<a href="${ pageContext.request.contextPath }/listCategory/<c:out value="${page - 1 }"/>">Pre</a>|
							</c:if>
