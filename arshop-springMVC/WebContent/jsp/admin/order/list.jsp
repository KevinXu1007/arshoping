...
<script type="text/javascript">
			function showDetail(oid){
				...
				if(but.value == "Detail"){
					...
					xhr.open("GET","${pageContext.request.contextPath}/findOrderItem/"+oid,true);
					xhr.send(null);
					but.value = "Close";
				}else{
					div1.innerHTML = "";
	...
	<form id="Form1" name="Form1"
		...
		<table cellSpacing="1" cellPadding="0" width="100%" align="center"
			...
			<TBODY>
					...
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr
								...
								<td align="center" width="10%">Order No.</td>
								...
								<td align="center" width="40%">Detail</td>
							...
							<c:forEach var="o" items="${orders}">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="10%"><c:out value="${o.oid }" /></td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="10%"><c:out value="${o.ordertime }" /></td>										
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="10%"><c:out value="${o.total }" /></td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="10%"><c:out value="${o.name }" /></td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="10%"><c:if test="${o.state==1}">
													Wait Payment
												</c:if> <c:if test="${o.state==2}">
											<a
												href="${ pageContext.request.contextPath }/updateStateOrder/<c:out value="${o.oid }"/>/<c:out value="${page}"/>">
												<font color="blue">Shipping</font>
											</a>
									...
									<input type="button" value="Detail" id="but<c:out value="${o.oid }"/>"
				...
				<tr align="center">
					<td colspan="7">page:<c:out value="${page }" />/<c:out
							value="${count }" /> <c:if test="${page != 1 }">
							<a href="${ pageContext.request.contextPath }/listOrder/1">First</a>|
								<a
								href="${ pageContext.request.contextPath }/listOrder/<c:out value="${page - 1 }"/>">Pre</a>|
